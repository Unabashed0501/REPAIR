...
from agentless.get_repo_structure.get_repo_structure import parse_python_file
...
class EmbeddingIndex(ABC):
    ...
    def retrieve(self, mock=False):
        ...
        print(f"Number of meta_infos: {len(meta_infos)}")
        print(f"Number of traj: {len(traj)}")
